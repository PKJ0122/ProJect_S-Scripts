...
public class Item_Rocket : ItemBase
{
    bool _itemUse;

    protected override void Awake()
    {
        itemtype = ItemCode.Rocket;
        base.Awake(); 
        Count = 1;
    }
    ...
    protected override void Update()
    {
        ...
        else
        {
            ...
            if (Input.GetKeyDown(KeyCode.E))
            {
                ...
                PhotonNetwork.Instantiate("Items/Item_Rocket", pos, Quaternion.identity)
                        .GetComponent<ItemEvent_Rocket>().isActive = true;
            }
        }
    }
