...
public class Item_LockOnBomb : ItemBase
{
    bool _itemUse;

    protected override void Awake()
    {
        itemtype = ItemCode.LockOnBomb;
        base.Awake();
        Count = 1;
    }
    ...
    protected override void Update()
    {
        ...
        else
        {
            ...
            if (Input.GetKeyDown(KeyCode.E))
            {
                ...
                PhotonNetwork.Instantiate("Items/Item_LockOnBomb", pos, Quaternion.identity)
                        .GetComponent<ItemEvent_LockOnBomb>().isActive = true;
            }
        }
    }
