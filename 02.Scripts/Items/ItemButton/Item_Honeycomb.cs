...
public class Item_Honeycomb : ItemBase
{
    bool _itemUse;

    protected override void Awake()
    {
        itemtype = ItemCode.PoisonBottle;
        base.Awake();
        Count = 1;
    }
    ...
    protected override void Update()
    {
        ...
        else
        {
            ...
            if (Input.GetKeyDown(KeyCode.E))
            {
                ...
                PhotonNetwork.Instantiate("Items/Item_PoisonBottle", pos, Quaternion.identity)
                        .GetComponent<ItemEvent_Honeycomb>().isActive = true;
            }
        }
    }
